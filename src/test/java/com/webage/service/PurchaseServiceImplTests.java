...
//         when(resourceServerDao.findAllCustomers(jwt)).thenReturn(expectedPurchases());
        
//         // Call the method under test
//         Iterable<Purchase> result = purchaseService.findAllCustomers();
...
//         when(resourceServerDao.findCustomerById(jwt, purchaseId)).thenReturn(expectedPurchase());
        
//         // Call the method under test
//         Optional<Purchase> result = purchaseService.findCustomerById(purchaseId);
...
//         // Verify interactions
//         verify(authorizationServerDao).getJwt();
//         verify(resourceServerDao).findCustomerById(jwt, purchaseId);
//     }
